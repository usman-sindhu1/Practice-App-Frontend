...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    ADMIN_SERVICE: (serviceId: string) => `/admin/services/${serviceId}`,
    ADMIN_DOCTOR_STATUS: (userId: string) => `/admin/doctors/${userId}/status`,
    PATIENT_MEDICAL_INFO: '/patients/me/medical-info',
    PATIENT_APPOINTMENTS: '/patients/me/appointments',
    PATIENT_APPOINTMENT: (appointmentId: string) => `/patients/me/appointments/${appointmentId}`,
    DOCTOR_APPOINTMENTS: '/doctors/me/appointments',
    DOCTOR_APPOINTMENT: (appointmentId: string) => `/doctors/me/appointments/${appointmentId}`,
